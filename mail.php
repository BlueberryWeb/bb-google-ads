...
$sender = 'noreply.blueberry.ads@gmail.com';
$senderName = 'Nuevo Contacto en blueberryads.mx';

$recipient1 = 'pruebascorreosbb@gmail.com';
$recipient2 = 'noreply.blueberry@gmail.com';
$recipient3 = 'ventas01bb@gmail.com';
$recipient4 = 'fidelberry1@gmail.com';
$recipient5 = 'noreply.blueberry.ads@gmail.com';

$usernameSmtp = 'noreply.blueberry.ads@gmail.com';
$passwordSmtp = 'zurcgqbnxoqyplyg';
$configurationSet = 'ConfigSet';
$host = 'smtp.gmail.com';
$port = 587;
$subject = 'Mensaje de Blueberry Ads';
        ...
        <table role="presentation" style="width:602px;border-collapse:collapse;border:0px solid #cccccc;border-spacing:0;text-align:left; font-family: -apple-system, BlinkMacSystemFont, Roboto, Oxygen, Ubuntu, Cantarell, sans-serif;">
          ...
          <tr>
            <td style="padding:0px 30px 42px 20px; font-family: -apple-system, BlinkMacSystemFont, Roboto, Oxygen, Ubuntu, Cantarell, sans-serif;">
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0; ont-family: -apple-system, BlinkMacSystemFont, Roboto, Oxygen, Ubuntu, Cantarell, sans-serif;">
              <tr>
                  <td style="width:260px;padding:0;vertical-align:top; color:#153643; font-family: -apple-system, BlinkMacSystemFont, Roboto, Oxygen, Ubuntu, Cantarell, sans-serif;">
...
define("RECAPTCHA_V3_SECRET_KEY", '6LecZ1UgAAAAADX_o2w2k0Z43tgTJyE1bMxaLHUQ');
$token = $_POST['token'];
$action = $_POST['action'];
